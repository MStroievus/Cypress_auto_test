class DocumentCreatePageModalWindow {
    ...
    constructor() {
        ...
        this.createButton = 'button.uuelements-10sdgj0.uuelements-c3sdc8[type="button"][aria-pressed="false"]'
...
export default DocumentCreatePageModalWindow;
